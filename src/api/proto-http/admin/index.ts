...
export type GetOrdersByStatusAndPaymentMethodRequest = {
  status: common_OrderStatusEnum | undefined;
  paymentMethod: common_PaymentMethodNameEnum | undefined;
  limit: number | undefined;
  offset: number | undefined;
...
export type GetOrdersByStatusAndPaymentMethodResponse = {
  orders: common_OrderFull[] | undefined;
};
...
export type AddArchiveRequest = {
  archiveNew: common_ArchiveNew | undefined;
};

// ArchiveNew represents a new archive with items for insertion.
export type common_ArchiveNew = {
  archive: common_ArchiveInsert | undefined;
...
export type AddArchiveItemsRequest = {
  archiveId: number | undefined;
  items: common_ArchiveItemInsert[] | undefined;
};

export type AddArchiveItemsResponse = {
...
export type DeleteArchiveItemResponse = {
};
...
export type SetShipmentCarrierAllowanceRequest = {
  carrier: string | undefined;
  allow: boolean | undefined;
};

export type SetShipmentCarrierAllowanceResponse = {
};

export type SetShipmentCarrierPriceRequest = {
  carrier: string | undefined;
  price: googletype_Decimal | undefined;
};

export type SetShipmentCarrierPriceResponse = {
};

export type SetPaymentMethodAllowanceRequest = {
  paymentMethod: common_PaymentMethodNameEnum | undefined;
  allow: boolean | undefined;
};

export type SetPaymentMethodAllowanceResponse = {
};

export type SetSiteAvailabilityRequest = {
  available: boolean | undefined;
};

export type SetSiteAvailabilityResponse = {
};

export type SetMaxOrderItemsRequest = {
  maxOrderItems: number | undefined;
};

export type SetMaxOrderItemsResponse = {
};
...
export interface AdminService {
  ...
  // Retrieves orders by their status
  GetOrdersByStatusAndPaymentMethod(request: GetOrdersByStatusAndPaymentMethodRequest): Promise<GetOrdersByStatusAndPaymentMethodResponse>;
  ...
  AddArchiveItems(request: AddArchiveItemsRequest): Promise<AddArchiveItemsResponse>;
  // DeleteArchiveItem deletes an archive item.
  DeleteArchiveItem(request: DeleteArchiveItemRequest): Promise<DeleteArchiveItemResponse>;
  ...
  SetShipmentCarrierAllowance(request: SetShipmentCarrierAllowanceRequest): Promise<SetShipmentCarrierAllowanceResponse>;
  SetShipmentCarrierPrice(request: SetShipmentCarrierPriceRequest): Promise<SetShipmentCarrierPriceResponse>;
  SetPaymentMethodAllowance(request: SetPaymentMethodAllowanceRequest): Promise<SetPaymentMethodAllowanceResponse>;
  SetSiteAvailability(request: SetSiteAvailabilityRequest): Promise<SetSiteAvailabilityResponse>;
  SetMaxOrderItems(request: SetMaxOrderItemsRequest): Promise<SetMaxOrderItemsResponse>;
}
...
export function createAdminServiceClient(
  ...
  return {
    ...
    GetProductsPaged(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/product/paged`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      if (request.limit) {
        queryParams.push(`limit=${encodeURIComponent(request.limit.toString())}`)
    ...
    CreateOrder(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/orders/create`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    ApplyPromoCode(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/apply-promo`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    UpdateOrderItems(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/update-items`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    UpdateOrderShippingCarrier(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/update-shipping-carrier`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    GetOrderInvoice(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/order/${request.orderId}/${request.paymentMethod}/invoice`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    SetTrackingNumber(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/set-tracking-number`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    UpdateShippingInfo(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/update-shipping-info`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    GetOrderById(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    GetOrdersByEmail(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/by-email/${request.email}`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    GetOrdersByStatus(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/by-status/${request.status}`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      if (request.limit) {
        queryParams.push(`limit=${encodeURIComponent(request.limit.toString())}`)
    ...
    GetOrdersByStatusAndPaymentMethod(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      if (!request.status) {
        throw new Error("missing required field request.status");
      }
      if (!request.paymentMethod) {
      ...
      const path = `api/admin/orders/by-status/${request.status}/${request.paymentMethod}`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      if (request.limit) {
        queryParams.push(`limit=${encodeURIComponent(request.limit.toString())}`)
      ...
      return handler({
        ...
        service: "AdminService",
        method: "GetOrdersByStatusAndPaymentMethod",
      }) as Promise<GetOrdersByStatusAndPaymentMethodResponse>;
    },
    RefundOrder(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      if (!request.orderId) {
        throw new Error("missing required field request.order_id");
      }
      const path = `api/admin/orders/${request.orderId}/refund`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    DeliveredOrder(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/delivered`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    CancelOrder(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      ...
      const path = `api/admin/orders/${request.orderId}/cancel`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    GetHero(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/hero`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
    ...
    AddArchiveItems(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/archive/add/items`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "AddArchiveItems",
      }) as Promise<AddArchiveItemsResponse>;
    },
    DeleteArchiveItem(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      if (!request.itemId) {
        throw new Error("missing required field request.item_id");
      }
      const path = `api/admin/archive/delete/item/${request.itemId}`; // eslint-disable-line quotes
      const body = null;
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "DeleteArchiveItem",
      }) as Promise<DeleteArchiveItemResponse>;
    },
    ...
    SetShipmentCarrierAllowance(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/settings/shipment-carrier-allowance`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "SetShipmentCarrierAllowance",
      }) as Promise<SetShipmentCarrierAllowanceResponse>;
    },
    SetShipmentCarrierPrice(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/settings/shipment-carrier-price`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "SetShipmentCarrierPrice",
      }) as Promise<SetShipmentCarrierPriceResponse>;
    },
    SetPaymentMethodAllowance(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      if (!request.paymentMethod) {
        throw new Error("missing required field request.payment_method");
      }
      const path = `api/admin/settings/payment-method-allowance/${request.paymentMethod}`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "SetPaymentMethodAllowance",
      }) as Promise<SetPaymentMethodAllowanceResponse>;
    },
    SetSiteAvailability(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/settings/site-availability`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "SetSiteAvailability",
      }) as Promise<SetSiteAvailabilityResponse>;
    },
    SetMaxOrderItems(request) { // eslint-disable-line @typescript-eslint/no-unused-vars
      const path = `api/admin/settings/max-order-items`; // eslint-disable-line quotes
      const body = JSON.stringify(request);
      const queryParams: string[] = [];
      let uri = path;
      if (queryParams.length > 0) {
      ...
      return handler({
        ...
        service: "AdminService",
        method: "SetMaxOrderItems",
      }) as Promise<SetMaxOrderItemsResponse>;
    },
  };
}
